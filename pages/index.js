      ...
      <main>
        ...
        <Row>
          ...
          <Col md={6}>
            ...
            <a className={styles.link} href='https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art' target="_blank">https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art</a>
          </Col>
        </Row>
      </main>
    </>
